...
class SearchNetworkProvider extends ApiService {
    ...
    Future<List<dynamic>> search(String term,[SearchCriteria? searchCriteria 
  ]) async {
    final Response response = await dio.get(
      searchCriteria == null ? Urls.SEARCH : Urls.SEARCH_FILTERED,
      queryParameters: {
        'term': term,
       if(searchCriteria != null) ...searchCriteria.toMap(),
      },
    );
